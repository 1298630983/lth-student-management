...
<div>
    <a href="/studentSystemServlet?opt=add">新增科创信息</a>
...
<table class="table table-condensed">
    ...
    <tbody>
    <c:forEach items="${studentSystemList}" var="studentSystem" varStatus="status">
        <tr>
            ...
            <td>
                <a href="/studentSystemServlet?opt=edit&id=${studentSystem.id}">编辑</a>
                <a href="/studentSystemServlet?opt=delete&id=${studentSystem.id}">删除</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
